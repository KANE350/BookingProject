            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item btn-lg"><a class="nav-link" href="${path}/comu/comulist">커뮤니티</a></li>
                        <li class="nav-item btn-lg"><a class="nav-link" href="${path}/review/reviewlist">리뷰</a></li>
